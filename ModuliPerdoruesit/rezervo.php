...
if(isset($_POST['Submit'])) {	
	...
	if(empty($cars) || empty($pu_location) || empty($pu_date) || empty($return_date) || empty($firstname) || empty($nrtel)) {
		...
		if(empty($cars)) {
			echo "<font color='red'>Ju lutem zgjedhni veturen</font><br/>";
		}
		if(empty($pu_location)) {
			echo "<font color='red'>Ju lutem zgjedhni vendin e marrjes .</font><br/>";
		}
		if(empty($pu_date)) {
			echo "<font color='red'>Ju lutem shkruani daten.</font><br/>";
		}
		if(empty($return_date)) {
			echo "<font color='red'>Ju lutem shkruani return date.</font><br/>";
		}
		if(empty($firstname)) {
			echo "<font color='red'>Ju lutem shkruani emrin.</font><br/>";
		}
		if(empty($nrtel)) {
			echo "<font color='red'>Ju lutem shkruani tel.</font><br/>";
		}
