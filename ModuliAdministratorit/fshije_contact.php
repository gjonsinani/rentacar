...
while($row = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"delete_contact.php?cid=$row[cid]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini kontaktin?')\" class='button' class='button primary'>Fshijë</a>
		</td></tr>";			
	}
