...
while($row = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"delete.php?uid=$row[uid]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\" class='button' class='button primary'>Fshijë</a>
		</td></tr>";		
	}
